...
$sql_1 = "SELECT * FROM cursos";
    ...
    if (mysqli_num_rows($result) <= 0) {
        ...
        ?>
                ...
                <table width="900" border="0">
                    ...
                    <tr>
                        <td>
                            <h3><?php echo $curso = $res_1['curso']; ?></h3>
                        </td>
                        <td>
            ...
            echo mysqli_num_rows($result2);?></h3>
                        ...
                        <td><a class="a"
                                href="cursos_e_disciplinas.php?pg=curso&deleta=cur&id=<?php echo @$res_1['id']; ?>"><img
                                    title="Excluir curso" src="img/deleta.jpg" width="18" height="18" border="0"></a>
                        </td>
                    </tr>
                    <?php }?>
                </table>
    ...
    if ($disciplina == '') {
        ...
        $sql_cad_disc = "INSERT INTO disciplinas (curso, disciplina, professor,turno ) VALUES ('$curso', '$disciplina', '$professor',  '$turno')";
...
$sql_result_prof = "SELECT * FROM professores WHERE nome != ''";
    ...
    while ($r3 = mysqli_fetch_assoc($result_rec_prof)) {
        ?>
                            ...
                            <td width="126"><input class="input" type="submit" name="cadastra" id="button"
                                    value="Cadastrar"></td>
                        </tr>
                    </table>
                </form>
    ...
    if (mysqli_num_rows($result_buscar_disc) == '') {
        ...
        ?>
                    <table width="900" border="0">
                        ...
                        <tr>
                            <td>
                                <h3><?php echo $res_busca['curso']; ?></h3>
                            </td>
                            <td>
                                <h3><?php echo $res_busca['disciplina']; ?></h3>
                            </td>
                            <td>
                                <h3>
                                    <?php
$professor = $res_busca['professor'];
            ...
            ?>
                            ...
                            <td><a class="a"
                                    href="cursos_e_disciplinas.php?pg=disciplina&deleta=sim&id=<?php echo $res_busca['id']; ?>"><img
                                        title="Excluir Disciplina" src="img/deleta.jpg" width="18" height="18"
                                        border="0"></a></td>
                        </tr>
                        <?php }?>
                    </table>
...
$sql_ced_prof = "SELECT * FROM disciplinas WHERE curso = '$curso'";
		...
		<?php }
            ...
            ?>
                ...
                <! MATRICULAR DISCIPLINAS>
                    ...
                    <div id="box_matriculas">
                        <a class="a2" href="cursos_e_disciplinas.php?pg=matricula&cadastra=sim">
                            Matricular Disciplina</a>
                        <//?php if (@$_GET['cadastra'] == 'sim') {?>
                        <h1>Cadastrar nova disciplina</h1>
    ...
    if ($code == '') {
        ...
        $sql_cad_disc = "INSERT INTO estudantes (serie, disciplina, code) VALUES ('$curso', '$disciplina', '$code')";
        $cad_disc = mysqli_query($conexao, $sql_cad_disc);
        if ($cad_disc == '') {
            echo "<script language='javascript'>window.alert('Ocorreu um erro!');</script>";
        } else {
...
$sql_rec_curso = "SELECT * FROM cursos";
    ...
    while ($r2 = mysqli_fetch_assoc($result_rec_curso)) {
        ?>
                                            <option value="<//?php echo $r2['curso']; ?>"><//?php echo $r2['curso']; ?>
                                            </option>
                                            <//?php }?>
                                        </select>
                                    </td>
...
$sql_rec_curso = "SELECT * FROM disciplinas";
    $result_rec_curso = mysqli_query($conexao, $sql_rec_curso);

    while ($r2 = mysqli_fetch_assoc($result_rec_curso)) {
        ?>
                                            <option value="<//?php echo $r2['disciplina']; ?>">
                                                <//?php echo $r2['disciplina']; ?>
                                            </option>
                                            <//?php }?>
                                        </select>
                                    </td>
...
$sql_result_prof = "SELECT * FROM estudantes WHERE nome != ''";
    $result_rec_prof = mysqli_query($conexao, $sql_result_prof);
    while ($r3 = mysqli_fetch_assoc($result_rec_prof)) {
        ?>
                                            <option value="<//?php echo $r3['code']; ?>"><?php echo $r3['nome']; ?>
                                            </option>
                                            <//?php }?>
                                        </select>
                                    </td>
