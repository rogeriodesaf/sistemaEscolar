...
$q = $_GET['q'];
    ...
    while ($res_1 = mysqli_fetch_assoc($sql_1)) {
        ...
        <table width="750" border="0">
            <tr>
                <td colspan="3">
                    <h1>Informações sobre este professor</h1>
                </td>
            </tr>
            <tr>
        ...
        <table width="750" border="0">
            ...
            <tr>
                <td width="248"><strong>Presenças:</strong>
                    <?php echo mysqli_num_rows(mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE code_aluno = '$q' AND presente = 'SIM' ")); ?>
                </td>
                <td colspan="2"><strong>Faltas:</strong>
                    <?php echo mysqli_num_rows(mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE code_aluno = '$q' AND presente = 'NÃO' ")); ?>
                </td>
                <td colspan="2"><strong>Faltas justificadas:</strong>
                    <?php echo mysqli_num_rows(mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE code_aluno = '$q' AND presente = 'JUSTIFICADA' ")); ?>
                </td>
            </tr>
            <tr>
                <td>
...
$sql_3 = mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE code_aluno = '$q' AND presente = 'JUSTIFICADA'");
    ...
    ?>
            ...
            <tr>
                <td colspan="5">
                    <h2><strong>Notas dos trabalhos semestrais</strong></h2>
                </td>
            </tr>
            <tr>
                <td><strong>Disciplina:</strong></td>
                <td width="119"><strong>1º Semestre</strong></td>
                <!--<td width="119"><strong>2º Semestre</strong></td>
    ...
    while ($res_3 = mysqli_fetch_assoc($sql_3)) {
        ...
        ?>
            <tr>
                ...
                <td>
                    <?php
$sql_4 = mysqli_query($conexao, "SELECT * FROM notas_trabalhos WHERE semestre = '1' AND disciplina = '$disciplina' AND code = '$q'");
        ...
        ?>
                ...
                <td>
                    <?php
//$sql_4 = mysqli_query($conexao, "SELECT * FROM notas_trabalhos WHERE semestre = '2' AND disciplina = '$disciplina' AND code = '$q'");
        ...
        ?>
                ...
                <td>
                    <?php
//$sql_4 = mysqli_query($conexao, "SELECT * FROM notas_trabalhos WHERE semestre = '3' AND disciplina = '$disciplina' AND code = '$q'");
        ...
        ?>
                ...
                <td>
                    <?php
//$sql_4 = mysqli_query($conexao, "SELECT * FROM notas_trabalhos WHERE semestre = '4' AND disciplina = '$disciplina' AND code = '$q'");
        ...
        ?>
            ...
            <tr>
                <td colspan="5">
                    <h2><strong>Notas de trabalhos extras</strong></h2>
                </td>
            </tr>
            <?php
$curso = $_GET['curso'];
...
$sql_4 = mysqli_query($conexao, "SELECT * FROM pontos_extras WHERE disciplina = '$disciplina' AND code = '$q'");
        ...
        ?>
            ...
            <tr>
                <td colspan="5">
                    <h2><strong>Notas das provas</strong></h2>
                </td>
            </tr>
            <tr>
                <td><strong>Disciplina:</strong></td>
                <td width="119"><strong> Semestre</strong></td>
                <!--<td width="119"><strong>2º Semestre</strong></td>
                <td width="119"><strong>3º Bimestre</strong></td>
    <td width="119"><strong>4º Bimestre</strong></td>-->
            </tr>
...
//$sql_4 = mysqli_query($conexao, "SELECT * FROM notas_provas WHERE bimestre = '4' AND disciplina = '$disciplina' AND code = '$q'");
        ...
        //  ?>
            ...
            <tr>
                <td colspan="5">
                    <h2><strong>Notas de observação</strong></h2>
                </td>
            </tr>
            <tr>
                <td><strong>Disciplina:</strong></td>
...
//$sql_4 = mysqli_query($conexao, "SELECT * FROM notas_observacao WHERE bimestre = '4' AND disciplina = '$disciplina' AND code = '$q'");
    ...
    /// ?>
            ...
            <tr>
                <td colspan="5">
                    <h2><strong>Notas semestrais</strong></h2>
                </td>
            </tr>
            <tr>
                <td><strong>Disciplina:</strong></td>
