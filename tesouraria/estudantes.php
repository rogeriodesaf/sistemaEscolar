...
?>
    ...
    <table width="900" border="0">
      ...
      <tr>
        ...
        <td></td>
        <td>
        <a class="a" href="estudantes.php?pg=todos&func=deleta&id=<?php  $res_1['id']; ?>&code=<?php  $res_1['code']; ?>"></a>
        <?php if($res_1['status'] == 'Inativo'){ ?>
        <a class="a" href="estudantes.php?pg=todos&func=ativa&id=<?php echo $res_1['id']; ?>&code=<?php echo $res_1['code']; ?>"></a>
        <?php } ?>
        <?php if($res_1['status'] == 'Ativo'){?>
        <a class="a" href="estudantes.php?pg=todos&func=inativa&id=<?php echo $res_1['id']; ?>&code=<?php echo $res_1['code']; ?>"></a>
        <?php } ?>
