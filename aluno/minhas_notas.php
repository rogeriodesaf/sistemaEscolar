...
<body>
    ...
    <div id="box">
        ...
        <h1><strong>Notas de seus trabalhos em cada semestre</strong></h1>
        <table width="900" border="0">
            <tr>
                <td width="317"><strong>DISCIPLINA<br /><br /></strong></td>
                <td width="150"><strong> Semestre</strong></td>
                <!--<td width="150"><strong>2º Semestre</strong></td>
...
$sql_1 = "SELECT * FROM disciplinas WHERE curso = '$serie'";
    ...
    while ($res_1 = mysqli_fetch_assoc($result_1)) {
        ...
        $sql_2 = "SELECT * FROM notas_trabalhos WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '1'";
        $result_2 = mysqli_query($conexao, $sql_2);
        //$sql_3 = "SELECT * FROM notas_trabalhos WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '2'";
        //$result_3 = mysqli_query($conexao, $sql_3);
        //$sql_4 = "SELECT * FROM notas_trabalhos WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '3'";
        //$result_4 = mysqli_query($conexao, $sql_4);
        //$sql_5 = "SELECT * FROM notas_trabalhos WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '4'";
...
//if (mysqli_num_rows($result_5) == '') {
        ...
        <h1><strong>Notas de suas provas em cada semestre</strong></h1>
        <table width="900" border="0">
            <tr>
                <td width="317"><strong>DISCIPLINA<br /><br /></strong></td>
                <td width="150"><strong> Semestre</strong></td>
...
$sql_1 = "SELECT * FROM disciplinas WHERE curso = '$serie'";
    ...
    while ($res_1 = mysqli_fetch_assoc($result_1)) {
        ...
        $sql_2 = "SELECT * FROM notas_provas WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '1'";
        $result_2 = mysqli_query($conexao, $sql_2);
        //$sql_3 = "SELECT * FROM notas_provas WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '2'";
        //$result_3 = mysqli_query($conexao, $sql_3);
        // $sql_4 = "SELECT * FROM notas_provas WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '3'";
        // $result_4 = mysqli_query($conexao, $sql_4);
        // $sql_5 = "SELECT * FROM notas_provas WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '4'";
        // $result_5 = mysqli_query($conexao, $sql_5);
        //?>
            <tr>
                <td><?php echo $disciplina; ?></td>
...
if (mysqli_num_rows($result_3) == '') {
            ...
            while ($res_3 = mysqli_fetch_assoc($result_3)) {
                ...
                if ($nota >= 7) {
                    "<h2><strong>" . $res_3['nota'] . "</strong>";
                } else {
                    "<h3><strong>" . $res_3['nota'] . "</strong></h3>";
                }
                if ($res_3['prova'] == '') {
                } else {
                    " | <a target='_blank' class='a5' href='../trabalhos_alunos/$prova'>Ver</a></h2>";
                }
            }}?>
                </td>
                <td>
...
if (mysqli_num_rows($result_5) == '') {
        ...
        <table width="900" border="0">
            <tr>
                <td width="317"><strong>DISCIPLINA<br /><br /></strong></td>
                <td width="150"><strong>1º Semestre</strong></td>
                <td width="150"><strong>2º Semestre</strong></td>
                <!--<td width="150"><strong>3º Bimestre</strong></td>
    <td width="150"><strong>4º Bimestre</strong></td>-->
            </tr>
...
$sql_1 = "SELECT * FROM disciplinas WHERE curso = '$serie'";
    ...
    while ($res_1 = mysqli_fetch_assoc($result_1)) {
        ...
        $sql_2 = "SELECT * FROM notas_observacao WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '1'";
        $result_2 = mysqli_query($conexao, $sql_2);

        $sql_3 = "SELECT * FROM notas_observacao WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '2'";
        $result_3 = mysqli_query($conexao, $sql_3);

        $sql_4 = "SELECT * FROM notas_observacao WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '3'";
        $result_4 = mysqli_query($conexao, $sql_4);

        $sql_5 = "SELECT * FROM notas_observacao WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '4'";
        $result_5 = mysqli_query($conexao, $sql_5);
...
if (mysqli_num_rows($result_5) == '') {
        ...
        <table width="900" border="0">
            <tr>
                <td width="317"><strong>DISCIPLINA<br /><br /></strong></td>
                <td width="120"><strong>1º Semestre</strong></td>
                <td width="120"><strong>2º Semestre</strong></td>
...
$sql_1 = "SELECT * FROM disciplinas WHERE curso = '$serie'";
    ...
    while ($res_1 = mysqli_fetch_assoc($result_1)) {
        ...
        $sql_2 = "SELECT * FROM notas_bimestrais WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '1'";
        $result_2 = mysqli_query($conexao, $sql_2);

        $sql_3 = "SELECT * FROM notas_bimestrais WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '2'";
        $result_3 = mysqli_query($conexao, $sql_3);

        $sql_4 = "SELECT * FROM notas_bimestrais WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '3'";
        $result_4 = mysqli_query($conexao, $sql_4);

        $sql_5 = "SELECT * FROM notas_bimestrais WHERE code = '$code' AND disciplina = '$disciplina' AND semestre = '4'";
        $result_5 = mysqli_query($conexao, $sql_5);
...
if (mysqli_num_rows($result_5) == '') {
        ...
        <h4>OBS: A média por bimestre é obtido da seguinte forma: nota do trabalho+nota da prova+nota de
            observação=Resultado da soma/3=Sua média naquele semestre</h4>
