...
<body>
    ...
    <div id="box">
        ...
        <h1><strong>Trabalhos semestrais lançados no sistema!</strong></h1>
    ...
    if (mysqli_num_rows($result_1) == '') {
        ...
        <table width="955" border="0">
            ...
            <tr>
                ...
                <td>
                    <h2><?php echo $res_1['bimestre']; ?>º Bimestre</h2>
                </td>
            </tr>
            <tr>
                <td><a href="detalhes_do_trabalho.php?id=<?php echo $res_1['id']; ?>&pg=trabalho_bimestral"
                        rel="superbox[iframe][515x400]">Mais detalhes</a></td>
                <?php
$sql_2 = "SELECT * FROM envio_de_trabalhos_bimestrais WHERE id_trabalho = " . $res_1['id'] . " AND aluno = '$code'";
            ...
            if (mysqli_num_rows($result_2) >= '1') {
                ...
                ?>
                <td colspan="2"><a
                        href="enviar_trabalho.php?id=<?php echo $res_1['id']; ?>&pg=trabalho_bimestral&aluno=<?php echo $code; ?>&dis=<?php echo $res_1['disciplina']; ?>&entrega=<?php echo $res_1['data_entrega']; ?>"
                        rel="superbox[iframe][400x190]">Enviar trabalho</a></td>
                <?php }?>
                <td></td>
                <td>&nbsp;</td>
            </tr>
...
$sql_1 = "SELECT * FROM trabalhos_extras WHERE status = 'Ativo' AND curso = '$serie'";
    ...
    if (mysqli_num_rows($result_1) == '') {
        ...
        <table width="955" border="0">
            ...
            <tr>
                <td><a href="detalhes_do_trabalho.php?id=<?php echo $res_1['id']; ?>&pg=trabalho_extras"
                        rel="superbox[iframe][515x400]">Mais detalhes</a></td>
                <?php
$sql_2 = "SELECT * FROM envio_de_trabalhos_extras WHERE id_trabalho = " . $res_1['id'] . " AND aluno = '$code'";
            ...
            if (mysqli_num_rows($result_2) >= '1') {
                ...
                ?>
                <td colspan="2"><a
                        href="enviar_trabalho.php?id=<?php echo $res_1['id']; ?>&pg=trabalho_extras&aluno=<?php echo $code; ?>&dis=<?php echo $res_1['disciplina']; ?>&entrega=<?php echo $res_1['data_entrega']; ?>"
                        rel="superbox[iframe][400x190]">Enviar trabalho</a></td>
                <?php }?>
                <td></td>
                <td>&nbsp;</td>
