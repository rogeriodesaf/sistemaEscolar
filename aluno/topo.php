...
<body>
    <div id="box_topo">
        ...
        <div id="mostra_login">
            <h1><strong>Olá :</strong> <?php echo $nome; ?> <strong><a href="../config.php?pg=sair">Sair</a></strong>
            </h1>
        </div><!-- mostra_login -->
    </div><!-- box_topo -->
            ...
            <ul>
                ...
                <li><a href="minhas_notas.php?pg=bimestrais">MINHAS NOTAS</a>
                    <ul>
                        ...
                        <li><a href="minhas_notas.php?pg=bimestrais">Notas Semestrais</a></li>
                    </ul>
                </li>
                <li><a href="">TRABALHOS</a>
                    <ul>
                        <li><a href="trabalhos.php?pg=trabalhos_bimestrais">Trabalhos semestrais</a></li>
