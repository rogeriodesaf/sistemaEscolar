...
<body>
    ...
    <div id="box">
        ...
        <div id="porteiro">
            <h1><strong><i><?php echo $nome ?> </i> - Seu código é:</strong> <?php echo $code ?> <a
                    href="../config.php?acao=quebra">
    ...
    if ($cpf == '') {
        ...
        if (mysqli_num_rows($result) <= 0) {
            ...
            <h3><strong>
                ...
                <a href="index.php?pg=confirma&code_a=<?php echo $code; ?>"><img src="../img/confirma.png"
                        title="Confirmar" border="0" width="22px" /></a>
